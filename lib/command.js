(function() {
  ...
  exports.Command = Command = (function() {
    ...
    Command.prototype.compile = function() {
      var config, file, l, less, options, outputDir, relations, save, sourceDir, _i, _len, _ref, _results,
        _this = this;
      ...
      if (_.any(options, function(value) {
        ...
        less = {};
        _ref = FileSystem.getFilesInTree(FileSystem.analyzeStructure(sourceDir, true, ['.less']));
        _results = [];
