(function() {
  ...
  exports.Command = Command = (function() {
    ...
    Command.prototype.compile = function() {
      var config, file, l, options, out, outputDir, relations, sourceDir, src, watchFiles, _i, _len, _results;
      var _this = this;
          ...
          try {
            ...
            if (_.any(options, function(value) {
              ...
              for (src in relations) {
                out = relations[src];
                if (path.join(sourceDir, src) === file) {
                  l.parse(path.join(outputDir, out), function(res) {
