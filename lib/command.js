(function() {
  ...
  exports.Command = Command = (function() {
    ...
    Command.prototype.compile = function() {
      var config, file, l, lessObjects, options, out, outputDir, relations, sourceDir, src, watchFiles, _i, _len, _results;
      var _this = this;
          ...
          try {
            ...
            if (_.any(options, function(value) {
              ...
              _results.push(l.watch(function() {
                return this.parse(function(css) {
                  var out, src, _results2;
                  var _this = this;
                  _results2 = [];
                  for (src in relations) {
