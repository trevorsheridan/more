      ...
      try {
        if (!this._parser) {
          ...
          this._parser.parse(this.read(), function(err, tree) {
            ...
            for (_i = 0, _len = _ref.length; _i < _len; _i++) {
              child = _ref[_i];
              _results.push(_this.relatives[child.slice(2)].changed.add(_this.changedCallback = function() {
                var callback, child;
          ...
          this._parser.parse(this.read(), function(err, tree) {
            ...
            if (err) {
              ...
              for (_i = 0, _len = _ref.length; _i < _len; _i++) {
                child = _ref[_i];
                _this.relatives[child.slice(2)].changed.remove(_this.changedCallback);
              }
              _ref2 = _.difference(_this.imports, lastImports);
              for (_j = 0, _len2 = _ref2.length; _j < _len2; _j++) {
                child = _ref2[_j];
                _this.relatives[child.slice(2)].changed.add(_this.changedCallback = function() {
                  var callback, child;
                  child = arguments[0], callback = 2 <= arguments.length ? __slice.call(arguments, 1) : [];
                  return this.onChange(child, callback[0]);
                }, _this);
